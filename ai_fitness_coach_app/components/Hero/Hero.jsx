        ...
        <section className="relative w-full min-h-screen flex items-center justify-center bg-black">
            ...
            <div className="relative z-10 text-left max-w-3xl px-6">
                ...
                <div className="mt-8 flex items-center gap-6">
                    <button
                        ...
                        className="inline-block px-6 py-3 bg-red-600 hover:bg-red-700 rounded-md text-white font-semibold shadow-md transition"
                    >
                        GET STARTED
                    </button>
                </div>
            ...
            {open && (
                <div className="fixed inset-0 flex items-center justify-center  bg-black/60 z-50">
                    {/* Modal container: white bg, limited height, scroll when needed */}
                    <div className="bg-white text-gray-500 p-6 rounded-xl shadow-2xl w-[90%] max-w-md relative max-h-[90vh] overflow-y-auto">
